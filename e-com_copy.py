...
# Initialize the emissions tracker with the country ISO code
...
emission_summary = tracker.co2_metric
print(f"Total emissions: {emission_summary['total']} {emission_summary['unit']}")
